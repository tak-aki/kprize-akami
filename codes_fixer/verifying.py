...
from .config import BATCH_SIZE, VALIDATION_COPY_COUNT, model_32b
...
def get_verification(
    ...
    logger.info(f"response_texts_from_inference token length : {[count_tokens(text, model_32b['tokenizer']) for text in response_texts]}")
